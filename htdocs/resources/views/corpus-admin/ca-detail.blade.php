        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card bg-light mb-3">
              ...
              <div class="card-body">
                <h5 class="card-title">3200<small> 件</small></h5>
                <p class="card-text">充分な量の学習データが登録されています。学習済みのデータを編集したい場合は、<a href="/corpus/training/view/1">データ管理</a>をご確認ください。</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card bg-light mb-3">
              ...
              <div class="card-body">
                <h5 class="card-title"><small>OK閾値：</small> - %<small>　/ NG閾値：</small>85.0%</h5>
                <p class="card-text">上記の閾値に基づいて、AIは判定結果を決定しています。閾値を編集したい場合は、<a href="/corpus/test/1">精度検証</a>をご確認ください。</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card bg-light mb-3">
              ...
              <div class="card-body">
                <h5 class="card-title"><small>適合率：</small>89.2%<small>　/ 再現率：</small>89.2%</h5>
                <p class="card-text">直近の精度検証の結果を表示しています。検証状況を確認したい場合は、<a href="/corpus/test/1">精度検証</a>をご確認ください。</p>
              </div>
            </div>
          </div>
        </div>
