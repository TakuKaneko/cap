...
!function (e) {
  e.fn.circliful = function (t, r) {
    var o = e.extend({ foregroundColor: "#3498DB", backgroundColor: "#ccc", pointColor: "none", fillColor: "none", foregroundBorderWidth: 15, backgroundBorderWidth: 15, pointSize: 28.5, fontColor: "#aaa", percent: 75, animation: 1, animationStep: 5, icon: "none", iconSize: "30", iconColor: "#ccc", iconPosition: "top", iconDecoration: !0, target: 0, start: 0, showPercent: 1, percentageTextSize: 22, percentageX: 100, percentageY: 113, textAdditionalCss: "", targetPercent: 0, targetTextSize: 17, targetColor: "#2980B9", text: null, textStyle: null, textColor: "#666", textY: null, textX: null, multiPercentage: 0, percentages: [], multiPercentageLegend: 0, textBelow: !1, noPercentageSign: !1, replacePercentageByText: null, halfCircle: !1, animateInView: !1, decimals: 0, alwaysDecimals: !1, title: "Circle Chart", description: "", progressColor: null }, t);return this.each(function () {
      function t() {
        var e = m,
            t = z;if (1 === o.multiPercentage) {
          var r,
              l = o.percentages,
              a = 360;for (r = 0; r < l.length; ++r) {
            t = a / 100 * (g = l[r].percent), e = i.find("#circle" + (r + 1)), r > 0 && (t = (a += 62.5) / 100 * g), n(e, t, a, g);
          }
        } else n(e, t, 360, g);
      }function n(t, n, l, a) {
        var c = window.setInterval(function () {
          P >= n ? (window.clearInterval(c), v = 1, "function" == typeof r && r.call(this)) : (P += b, B += T), o.halfCircle ? 2 * P / (l / 100) >= a && 1 === v && (P = l / 100 * a / 2) : P / (l / 100) >= a && 1 === v && (P = l / 100 * a), B > o.target && 1 === v && (B = o.target), null === o.replacePercentageByText && (S = o.halfCircle ? parseFloat(100 * P / l * 2) : parseFloat(100 * P / l), S = S.toFixed(o.decimals), !o.alwaysDecimals && (0 === a || a > 1 && 1 !== v) && (S = parseInt(S))), t.attr("stroke-dasharray", P + ", 20000"), 1 !== o.multiPercentage ? 1 === o.showPercent ? w.find(".number").text(S) : (w.find(".number").text(B), w.find(".percent").text("")) : (w.find(".number").text(""), w.find(".percent").text("")), null !== C && e.each(C, function (e, r) {
            o.halfCircle && (e /= 2), P >= e * (l / 100) && t.css({ stroke: r, transition: "stroke 0.1s linear" });
          });
        }.bind(t), k);
      }function l() {
        ...
        var t,
            ...
            n = i.width(),
            l = o.percentages,
            a = "";for (t = 0; t < l.length; ++t) {
          var c = l[t].title;a += '<div><span class="color-box" style="background: ' + l[t].color + '"></span>' + c + ", " + l[t].percent + "%</div>";
        }i.append(e("<div/>").append(a).attr("style", "position:absolute;top:" + r / 3 + "px;left:" + (n + 20) + "px").attr("class", "legend-line"));
      }var i = e(this);!function (t, r) {
        ...
        if (1 === o.multiPercentage) {
          ...
          T = 0,
          S = g,
          z = 3.6 * g;o.halfCircle && (z = 3.6 * g / 2), null !== o.replacePercentageByText && (S = o.replacePercentageByText), o.start > 0 && o.target > 0 && (g = o.start / (o.target / 100), T = o.target / 100), 1 === o.animation ? o.animateInView ? e(window).scroll(function () {
        a();
